...
return array (
    'phone' => 'يجب ان يكون رقم :attribute صحيح',
    ...
    'content' => 'المحتوى',
    'transaction_amount' => 'المبلغ المحول',
    ...
    array (
      ...
      'btn_url' => 'رابط الزر',
      'description' => 'وصف الأسلايدر',
      'image' => 'صورة',
      'title' => 'عنوان الأسلايدر',
    ),
    'subject' => 'الموضوع',
    'time' => 'الوقت',
    'title' => 'العنوان',
  ...
  'doesnt_end_with' => 'قد لايكون  :attribute ينتهي بواحدة من هذه القيم: :values.',
  'doesnt_start_with' => 'قد لايكون  :attribute يبدأ بواحدة من هذه القيم: :values.',
  ...
  'iban' => ' :attribute يجب أن يكون رقم حساب مصرفي دولي صالح ',
  ...
  'max_digits' => 'يجب أن لا يتجاوز طول حقل :attribute :max رقماَ',
  ...
  'min_digits' => 'يجب أن يكون طول نص حقل :attribute على الأقل :min رقماَ.',
  ...
  'password' =>
  array (
    'letters' => 'يجب أن تحتوي :attribute على حروف',
    'mixed' => 'يجب أن تحتوي :attribute على  حرفًا كبيرًا واحدًا وحرفًا صغيرًا على الأقل',
    'numbers' => 'يجب أن تحتوي :attribute على أرقام',
    'symbols' => 'يجب أن تحتوي :attribute على رموز',
    'uncompromised' => 'يجب أن تكون :attribute آمنة وغير متكررة',
  ),
  ...
  'required_if_accepted' => 'حقل :attribute مطلوب في حال ما إذا كانت حقول :other صحيحة',
